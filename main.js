...
function renderCompare() {
  ...
  if (epboxPrice) {
    ...
    cardHtml += '<div style="font-size:12px;color:rgba(255,255,255,0.85);font-weight:500;">EPBOX 自助回收機' + (!batteryGood ? ' · <span style="color:#a0ffca;font-weight:700;">電池不扣款</span>' : '') + '</div>';
...
function renderCalculator() {
  ...
  <div class="avg-banner" style="margin-bottom:14px;">
    ...
    <div style="flex:1">
      ...
      <div style="font-size:11px;color:rgba(255,255,255,0.65);margin-top:2px;">EPBOX 自助回收參考價</div>
    </div>
